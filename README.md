...
이 프로젝트는 [외부 API(카카오 주소 검색 API)](https://developers.kakao.com/docs/latest/ko/local/dev-guide)와 [공공 데이터(주차장 현황 정보)](https://www.data.go.kr/data/15065023/fileData.do)를 활용하여 실제 서비스로 제공할 수 있는 수준의 주차장 추천 시스템을 구현합니다. 추천된 주차장의 길 안내는 [카카오 지도 및 로드뷰 바로가기 URL](https://apis.map.kakao.com/web/guide/#routeurl)로 제공됩니다.
...
- 사용자가 입력한 주소 정보를 기반으로 가까운 주차장 3곳을 추천합니다.
- 주소 입력 및 처리:
